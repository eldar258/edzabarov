...
public class PaintTest {
	...
	*/
    ...
    public void whenPiramidWithHeightFiveThenStringWithFiveRows() {
        ...
        String expected = String.format("    ^    %s   ^^^   %s  ^^^^^  %s ^^^^^^^ %s^^^^^^^^^", System.getProperty("line.separator"), System.getProperty("line.separator"), System.getProperty("line.separator"), System.getProperty("line.separator"), System.getProperty("line.separator"));
        assertThat(result, is(expected));
    }
	/**
	*Test piramid.
