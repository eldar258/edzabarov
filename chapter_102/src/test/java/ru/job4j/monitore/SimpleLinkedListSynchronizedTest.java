 ...
 * @since 03.03.2018
 */
public class SimpleLinkedListSynchronizedTest {
    private class SimpleThread implements Runnable {
        SimpleLinkedListSynchronized<Integer> list;

        public SimpleThread(SimpleLinkedListSynchronized<Integer> list) {
            this.list = list;
        }
    ...
    public void whenAdd500000ElementsThenCountElementsEquals500000() {
        SimpleLinkedListSynchronized<Integer> list = new SimpleLinkedListSynchronized<>();
